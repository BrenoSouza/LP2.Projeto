...
public class AluguelCarro extends Servico implements Serializable {
	 ...
	 * @throws ParametrosInvalidosException Se o número de diárias for menor que 1.
	 */
	
	public AluguelCarro(int diarias, boolean isLuxo, boolean isTanqueCheio, boolean isSegurado) throws ParametrosInvalidosException {
		super();
		if (diarias < 1) {
			throw new ParametrosInvalidosException("Parametros inválidos!");
		}
